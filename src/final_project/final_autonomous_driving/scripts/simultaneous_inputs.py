...
class Keyboard():
    def __init__(self):
        ...
        self.movement_publisher = rospy.Publisher('driving_input', VehicleInput, queue_size=10)
        self.ros_rate = 50
        self.kAccel = 1.0
        self.kAngle = 0.1
        self.PI = 3.14159265358979323846
        self.use_manual = True#rospy.get_param("ego/autonomous_driving/use_manual_inputs")
    ...
    def run(self):
        ...
        while not rospy.is_shutdown():
            ...
            input.steering = frontAngle/180.0*self.PI
            input.brake = brake/100.0
            self.movement_publisher.publish(input)
            rate.sleep()
